...
public class EventYearAdapter0 extends RecyclerView.Adapter<EventYearAdapter0.RecyclerViewHolder> {
    private Context mContext;
    private List<YearDateModel> yearDateModels;

    public EventYearAdapter0(Context context, List<YearDateModel> yearDateModels){
        mContext = context;
        this.yearDateModels = yearDateModels;
    }

    public EventYearAdapter0(Context context){
        mContext = context;
    }
