...
public class EventMonthAdapter1 extends RecyclerView.Adapter<EventMonthAdapter1.RecyclerViewHolder> {
    private Context mContext;
    private Calendar mCalendar;

    public EventMonthAdapter1(Context context){
        mContext = context;
    ...
    public void onBindViewHolder(RecyclerViewHolder viewHolder, int position) {
        MonthDateModel monthDateModel = DateModelUtil.getMonthDateModel(position/12+1, position%12+1, true);
        List<DayDateModel> dayDateModels = monthDateModel.getDayDateModels();
        ...
        viewHolder.tv_month.setText(monthDateModel.getMonth()+"月");
