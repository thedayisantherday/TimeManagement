...
package com.timemanagement.zxg.widget.wheelview.view;
...
import com.timemanagement.zxg.widget.wheelview.adapters.WheelViewAdapter;
import com.timemanagement.zxg.widget.wheelview.listener.OnWheelChangedListener;
import com.timemanagement.zxg.widget.wheelview.listener.OnWheelClickedListener;
import com.timemanagement.zxg.widget.wheelview.listener.OnWheelScrollListener;
import com.timemanagement.zxg.widget.wheelview.model.ItemsRange;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.color_C7C7C7));
		// 设置线宽
	...
	public void setItemViewPadding(int left, int top, int right, int bottom){
		paddings[0]=left;
		paddings[1]=top;
		paddings[2]=right;
		paddings[3]=bottom;
